...
class ConfirmPedidoAdapter( private val productos: List<Producto>, private var productoDetail: ProductoDetailListener, private val precioTotal: Double, private val cantidad: Int ):
    ...
    override fun onBindViewHolder(holder: ConfirmPedidoViewHolder, position: Int) {
        ...
        holder.bind( item, productoDetail, precioTotal, cantidad )
    }
