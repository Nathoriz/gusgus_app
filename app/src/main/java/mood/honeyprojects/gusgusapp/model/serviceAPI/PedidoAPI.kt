...
interface PedidoAPI {
    ...
    fun FindPedidosById(@Query( "pedidoid" ) pedidoid: String ): Call<List<Pedido>>
    ...
    @PUT("pedidos/estado/{id}/{estado}")
    fun cambioEstadoPedido(@Path( "id" ) id: Long,@Path( "estado" ) estado: String): Call<String>
}